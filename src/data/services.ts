...
export const services: Service[] = [
  ...
  // VERIFICHE IPOTECARIE
  {
    ...
    description: "Documento ufficiale dell'Agenzia delle Entrate con l'elenco delle formalità (trascrizioni, iscrizioni e annotazioni) registrate nella banca dati ipotecaria relative.",
    price: 19.90,
